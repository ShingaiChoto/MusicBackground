...
fetch_thumb() {
    ...
    curl -so "${THUMB}.jpeg" "$artUrl"
    magick "${THUMB}.jpeg" -quality 50 "${THUMB}.jpeg"
    # Create blurred version
    magick "${THUMB}.jpeg" -blur 200x7 -resize 1920x^ -gravity center -extent 1920x1080\! "${THUMB_BLURRED}.jpg"
